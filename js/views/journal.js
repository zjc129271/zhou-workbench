...
function entryHtml(j) {
  ...
  return `<li class="list-item">
      ...
      <div class="list-item__title">${kindLabel} <span class="muted" style="font-weight:400;font-size:13px">${fmtDate(j.ts)}</span></div>
...
export async function render(container, ctx) {
  ...
  container.innerHTML = `
    ...
    <div class="card">
      <div class="card__title">记录列表 <span class="muted" style="font-weight:400;font-size:14px">${entries.length}</span>
