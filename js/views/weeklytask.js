...
export async function render(container, ctx) {
  ...
  container.innerHTML = `
    <div class="card">
      <div class="card__title">每周任务 <span class="muted" style="font-weight:400;font-size:14px">${weeklyTasks.length}</span></div>
    ...
    <div class="card">
      ...
      <div class="muted" style="font-size:13px">🔴：该周有未完成的每周任务</div>
    </div>`;
