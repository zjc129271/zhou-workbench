...
export async function render(container, ctx) {
  ...
  container.innerHTML = `
    <div class="card">
      <div class="card__title">${fmtDate(new Date(selDay).getTime())} 的每日任务 <span class="muted" style="font-weight:400;font-size:14px">${dailyTasks.length}</span></div>
    ...
    <div class="card">
      ...
      <div class="muted" style="font-size:13px;margin-top:8px">红点：该日有未完成的每日任务</div>
    </div>`;
