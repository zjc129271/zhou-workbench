  ...
  const mask = openModal(`
    <div class="modal-card">
      <div class="modal-head">
        ...
        <button class="icon-btn" id="im-close" aria-label="关闭" style="font-size:19px">✕</button>
      </div>
      <div class="modal-card__body" style="padding:14px 18px">
        <p class="muted" style="font-size:14px;line-height:1.6;margin:0 0 10px">
        ...
        <label class="row" style="gap:8px;align-items:center;margin-top:8px;font-size:15px">
          <input type="checkbox" id="im-dedupe" /> 跳过重复记录（按 日期+金额+类别+备注 判断）
        </label>
        <div id="im-result" class="muted" style="font-size:14px;margin-top:10px;min-height:18px"></div>
      </div>
