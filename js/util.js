  ...
  return new Promise((resolve) => {
    const mask = openModal(`
      <div class="modal-card" style="max-width:320px">
        <div class="modal-card__body" style="padding:18px 18px 10px;font-size:16px;line-height:1.6">${esc(message)}</div>
...
export function promptModal(message, defaultVal = '') {
  return new Promise((resolve) => {
    const mask = openModal(`
      <div class="modal-card" style="max-width:320px">
        <div class="modal-card__body" style="padding:16px 18px 6px;font-size:15px;color:var(--muted)">${esc(message)}</div>
