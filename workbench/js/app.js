  ...
  const mask = openModal(`
    <div class="modal-card" style="max-width:360px">
      <div class="modal-head">
        <div style="font-size:15px;font-weight:700">如何安装到桌面</div>
        <button class="icon-btn" id="ih-close" aria-label="关闭" style="font-size:18px">✕</button>
      </div>
      <div style="font-size:14px;line-height:1.7;color:var(--text);padding:4px 0 16px">${body}</div>
